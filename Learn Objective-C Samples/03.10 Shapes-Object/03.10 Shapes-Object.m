...
int main (int argc, const char * argv[]) 
{
	...
	ShapeRect rect0 = { 0, 0, 10, 30 };//set up ShapeRect struct with these values
	shapes[0] = [Circle new];//id is a generic class, we can set it to any class type??
	[shapes[0] setBounds: rect0];//send the setbound
